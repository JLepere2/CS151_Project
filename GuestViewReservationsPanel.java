...
public class GuestViewReservationsPanel extends JPanel {
		...
		cancelButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (selectedReservation != null) {
					int result = JOptionPane.showOptionDialog(null, "Are you sure you want to cancel this reservation?", "Cancel", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE, null, null, null);
	 ...
	 * @param reservationInfoTextArea the reservation information text area.
	...
	private void setSelectedRow(JTextArea reservationInfoTextArea, Reservation reservation) {
		...
		String resevationInfoText = "Room Type: " + selectedReservation.getHotelRoom().getRoomType() + "\n" +
				...
				"Room Price: $" + selectedReservation.getReservationPrice() + "\n" + 
				"Length of Reservation: " + selectedReservation.getTime();
