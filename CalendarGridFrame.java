...
public class CalendarGridFrame extends JFrame {
	 ...
	 * @param theTextFieldText the newly updated text field
	 * @param otherTextField the other text field
	 * @param settingFrom setting the from field or the to field
	 * @return true if the other text field should be set to the newly updated text field.
	 */
